return {
  ...
  { import = "lazylite.plugins.extras.lang.git" },
  ...
  -- Octo Picker
  {
    ...
    opts = function(_, opts)
      ...
      if LazyLite.has("telescope.nvim") then
        opts.picker = "telescope"
      elseif LazyLite.has("fzf-lua") then
        opts.picker = "fzf-lua"
      else
        LazyLite.error("`octo.nvim` requires `telescope.nvim` or `fzf-lua`")
      end
