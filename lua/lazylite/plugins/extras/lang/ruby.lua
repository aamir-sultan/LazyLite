if lazylite_docs then
  ...
  vim.g.lazylite_ruby_lsp = "ruby_lsp"
  vim.g.lazylite_ruby_formatter = "rubocop"
end

local lsp = vim.g.lazylite_ruby_lsp or "ruby_lsp"
if vim.fn.has("nvim-0.10") == 0 then
  -- ruby_lsp does not work well with Neovim < 0.10
  lsp = vim.g.lazylite_ruby_lsp or "solargraph"
end
local formatter = vim.g.lazylite_ruby_formatter or "rubocop"
